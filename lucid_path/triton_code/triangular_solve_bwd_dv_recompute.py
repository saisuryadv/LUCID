...
def triangular_solve_bwd_dv_kernel(
    ...
    # Helper tensors (computed on-the-fly, like forward)
    q_new, k_new, w2,
    # Outputs
    ...
    # ==========================================================================
    # Pass 1: Compute k_new, w2, q_new (TOP TO BOTTOM, same as forward)
    # These are needed for off-diagonal A[i,k] computation in Pass 3.
    # ==========================================================================
    for i_t in range(NT):
    ...
    # ==========================================================================
    # Pass 2: Initialize dV = dO (dV serves as accumulator R)
    # ==========================================================================
    ...
    # ==========================================================================
    # Pass 3: Sequential loop over block rows (BOTTOM TO TOP)
    #
    ...
    for i_t in range(NT - 1, -1, -1):
        ...
        # Load q_new for this row (precomputed in Pass 1, used for off-diagonal blocks)
...
def triangular_solve_bwd_dv_fn_recompute(
    q, k, w, beta, A,
    do,
    scale,
    BT,
    ...
    # Allocate helper tensors (computed on-the-fly in kernel, like forward)
